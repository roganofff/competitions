    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, default=competitions_app.models.get_datetime, null=True, validators=[competitions_app.models.check_created], verbose_name='created')),
                ('modified', models.DateTimeField(blank=True, default=competitions_app.models.get_datetime, null=True, validators=[competitions_app.models.check_modified], verbose_name='modified')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, default=competitions_app.models.get_datetime, null=True, validators=[competitions_app.models.check_created], verbose_name='created')),
                ('modified', models.DateTimeField(blank=True, default=competitions_app.models.get_datetime, null=True, validators=[competitions_app.models.check_modified], verbose_name='modified')),
                ('money', models.DecimalField(decimal_places=2, default=0, max_digits=11, validators=[competitions_app.models.check_positive], verbose_name='money')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet_coefficient', models.DecimalField(decimal_places=2, default=competitions_app.models.get_random_bet_coefficient, max_digits=5, verbose_name='bet_coefficient')),
                ('comp_sport', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='competitions_app.competitionssports', verbose_name='comp_sport')),
            ],
            options={
                'verbose_name': 'Stage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, default=competitions_app.models.get_datetime, null=True, validators=[competitions_app.models.check_created], verbose_name='created')),
                ('modified', models.DateTimeField(blank=True, default=competitions_app.models.get_datetime, null=True, validators=[competitions_app.models.check_modified], verbose_name='modified')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='competitions_app.client', verbose_name='client')),
                ('stages', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='competitions_app.stage', verbose_name='stage')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='stage',
            name='clients',
            field=models.ManyToManyField(through='competitions_app.StageClient', to='competitions_app.client', verbose_name='users'),
        ),
        migrations.AddField(
            model_name='client',
            name='stages',
            field=models.ManyToManyField(through='competitions_app.StageClient', to='competitions_app.stage', verbose_name='stages'),
        ),
